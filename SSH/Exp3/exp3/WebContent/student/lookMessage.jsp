<%@page contentType="text/html" pageEncoding="UTF-8" import="java.util.ArrayList,PO.StuInfoPO"%>
    ...
    <body bgcolor="white">
        ...
        <table align="center" width="80%">
            <tr>
                ...
                <td width="25%">
                    <s:a href="http://localhost:8080/exp3/student/deleteMessage.jsp">删除学生信息</s:a>
                </td>
            </tr>
        </table>
        <br/>
